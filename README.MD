...
Tugas ini bertujuan untuk memahami perbedaan arsitektur antara berbagai model **Vision Transformer**, mengimplementasikan **transfer learning** pada dataset klasifikasi penyakit daun padi, serta menganalisis trade-off antara **akurasi**, **kompleksitas model**, dan **efisiensi inferensi**.
...
- **Kelas**: 4 jenis penyakit
  ...
  - `Brownspot` (322)
  - `Tungro` (252)
- **Sumber**: Dataset custom (koleksi pribadi + PlantVillage)
- **Distribusi**: Cukup merata (selisih maksimal ~84 gambar)
- **Lokasi**: [Google Drive – Dataset Tugas Yohanna](https://drive.google.com/drive/folders/1h5vmKgw-VAmjtCOV8PXcysJMT1OFIdD8?usp=drive_link)  
...
> **Bonus nilai**: Membandingkan **3 model** + **visualisasi attention map** → memenuhi kriteria bonus maksimal.
...
| ------------- | ------------------------- | -------------------- |
| **ViT-B/16**  | 390.66                    | 2.56                 |
| **Swin-Tiny** | 142.72                    | 7.01                 |
| **DeiT-Tiny** | **27.96**                 | **35.77**            |
...
- **Kurva Learning**:  
  Menunjukkan konvergensi stabil dalam 3 epoch untuk ketiga model.

- **Confusion Matrix**:  
  Visualisasi matriks 4×4 dengan semua prediksi benar.
...
- (Opsional) Screenshot hasil eksperimen dan visualisasi
